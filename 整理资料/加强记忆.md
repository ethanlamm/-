...
![image-20221102152344039](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221102152344039.png)
...
![image-20220822220627443](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220822220627443.png)
...
<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\语义化标签.jpg" alt="img2022" style="zoom:50%;" />
...
本质是一个字符串，由三部分组成：头部(Header)--JSON对象、载荷(Payload)--JSON对象、签名(Signature)，以`.`进行拼接
...
![image-20221102160353350](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221102160353350.png)
...
浏览器发起HTTP请求到服务器，服务器进行cookie设置，也就是Set-Cookie，cookie有name和value两个属性，服务器会把两个值填充完整后发给浏览器，浏览器会保存起来，这样浏览器以后的每个请求都会自动附上已存储的cookie



基于cookie的session  需要设置session，用到第三方库 [express-session](https://www.npmjs.com/package/express-session)

![image-20220902210928235](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220902210928235.png)
...
<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220905094202889.png" alt="image-20220905094202889" style="zoom: 50%;" />
...
![image-20220905095305598](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220905095305598.png)
...
![image-20220905122331524](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220905122331524.png)

![image-20220905122331524](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\chrome-capture-2022-8-5.gif)
...
<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220906145224052.png" alt="image-20220906145224052" style="zoom: 50%;" />



域名和ip对应关系 

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220906152415939.png" alt="image-20220906152415939" style="zoom: 67%;" />

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220906152622247.png" alt="image-20220906152622247" style="zoom: 50%;" />
...
<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220906173154777.png" alt="image-20220906173154777" style="zoom: 50%;" />
...
![img](https://pic2.zhimg.com/80/v2-8df9d864a263990fee83b48b29c987ad_1440w.jpg)
...
![image-20221102160229935](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221102160229935.png)
...
![image-20220925093640579](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20220925093640579.png)
...
- useEffect：在函数式组件中实现一些带有副作用的操作，依据不同的依赖项执行的时机不同。如果没有依赖项，则初次渲染和每次更新都会执行；如果依赖项是空数组，则只有首次渲染会执行；如果是特定的依赖项，是首次渲染和依赖项发生改变时会执行
...
Mobx是一个独立的响应式的库，通常习惯把它和React进行绑定使用，用Mobx来做响应式数据建模，React作为UI视图框架渲染内容，需要下载mobx框架和链接mobx和react的中间件
...
3. 定义修改数据的函数 **action**、通过**get**关键词定义计算属性
4. 实例化**store**并导出
...
![image-20221008140722857](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221008140722857.png)

#

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221006215640742.png" alt="image-20221006215640742" style="zoom: 33%;" />

#

![image-20221006215707669](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221006215707669.png)

#

![image-20221007093929086](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221007093929086.png)

#

![image-20221006215808860](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221006215808860.png)

#

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221006225741737.png" alt="image-20221006225741737" style="zoom:67%;" />

#

![image-20221007093639226](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221007093639226.png)
...
![image-20221007220758124](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221007220758124.png)

#

![image-20221007220914809](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221007220914809.png)
...
<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221007221054844.png" alt="image-20221007221054844" style="zoom: 67%;" />

#

![image-20221007220344912](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221007220344912.png)

---

##### 类的继承（**extends**关键字）

![image-20221008163442023](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221008163442023.png)
...
<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021083844598.png" alt="image-20221021083844598" style="zoom: 40%;" />
...
![](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\1782626178-bfa9c9ce6a459b9e_fix732.png)
...
<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021091454747.png" alt="image-20221021091454747" style="zoom: 50%;" />

- 迭代查询

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021091527785.png" alt="image-20221021091527785" style="zoom:50%;" />
...
![image-20221021091800068](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021091800068.png)
...
![image-20221021141726095](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021141726095.png)

3.[CDN原理](https://juejin.cn/post/6844903890706661389#heading-5)

![image-20221021141834481](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021141834481.png)

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021141911032.png" alt="image-20221021141911032" style="zoom:50%;" />
...
![image-20221021144808733](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021144808733.png)

![image-20221021144823574](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021144823574.png)
...
<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\b6cdd800-b393-11eb-ab90-d9ae814b240d.png" style="zoom:50%;" />
...
![image-20221021151258105](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021151258105.png)
...
![image-20221021224751136](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20221021224751136.png)
